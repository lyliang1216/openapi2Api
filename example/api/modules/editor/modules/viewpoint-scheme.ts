...
export function useViewpointSchemeApi() {
  return {
    ...
    ViewpointScheme_projectId_sadiIdGET(
      data: { projectId: number | string; sadiId: number | string },
      config = {}
    ): Promise<IViewPointVoListResponse> {
      return request({
    ...
    ViewpointScheme_projectId_sadiId_schemeIdDELETE(
      data: {
     ...
     * @param data.sadiId sadi id
     * @param data.schemeId 视点方案id*/
    ViewpointScheme_Download_projectId_sadiId_schemeIdGET(
      data: {
        projectId: number | string;
        sadiId: number | string;
        schemeId: number | string;
     ...
     * @param data.sadiId sadi id
     * @param data.schemeId 视点方案id*/
    ViewpointScheme_Copy_projectId_sadiId_schemeIdPOST(
      data: {
        projectId: number | string;
        sadiId: number | string;
        schemeId: number | string;
