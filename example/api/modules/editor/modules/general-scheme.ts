...
export function useGeneralSchemeApi() {
  return {
    ...
    /**GeneralScheme-删除综合方案
     * @param data.projectId 项目id
     * @param data.sadiId sadi id
     * @param data.schemeId 综合方案id*/
    GeneralScheme_projectId_sadiId_schemeIdDELETE(
      data: {
