...
export function useLabelSchemeApi() {
  return {
    ...
    LabelScheme_projectId_sadiIdGET(
      data: { projectId: number | string; sadiId: number | string },
      config = {}
    ): Promise<ILabelRecordVoListResponse> {
      return request({
    ...
    LabelScheme_projectId_sadiId_recordIdDELETE(
      data: {
    ...
    LabelScheme_Copy_projectId_sadiId_schemeIdPOST(
      data: {
        projectId: number | string;
        sadiId: number | string;
