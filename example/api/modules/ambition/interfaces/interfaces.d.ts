...
msg?: string;
    ...
    /**VisualConfig */
 declare interface IVisualConfig {
/**主键 */
id?: number;
/**可视化表主键 */
visualId?: number;
...
suppressedExceptions?: IThrowable[];
    ...
    /**IPageVisual */
 declare interface IIPageVisual {
records?: IVisual[];
total?: number;
size?: number;
current?: number;
...
format?: number;
    ...
    /**RIPageVisual */
 declare interface IRIPageVisual {
/**状态码 */
code?: number;
/**是否成功 */
success?: boolean;
