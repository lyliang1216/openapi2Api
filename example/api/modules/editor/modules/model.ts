...
export function useModelApi() {
  return {
    ...
    Model_PagePOST(
      data: IModelPageBo,
      config = {}
    ): Promise<IModelVoPageResultVoResponse> {
      return request({
        url: `/model/page`,
    ...
    Model_Download_projectId_sadiIdGET(
     ...
     * @param data.projectId 项目id
     * @param data.sadiId sadi id*/
    Model_Custom_Download_projectId_sadiIdGET(
      data: { projectId: number | string; sadiId: number | string },
      config = {}
    ): Promise<ArrayBuffer> {
      return request({
     ...
     * @param data.projectId 项目id
     * @param data.sadiId sadi id*/
    Model_Custom_Exist_projectId_sadiIdGET(
      data: { projectId: number | string; sadiId: number | string },
      config = {}
     ...
     * @param data.projectId 项目id
     * @param data.sadiId sadi id*/
    Model_Hiddens_projectId_sadiIdGET(
      data: { projectId: number | string; sadiId: number | string },
      config = {}
     ...
     * @param data.projectId 项目id
     * @param data.sadiId sadi id*/
    Model_Conf_Download_projectId_sadiIdGET(
      data: { projectId: number | string; sadiId: number | string },
      config = {}
    ): Promise<ArrayBuffer> {
      return request({
