...
export function usePropertyApi() {
  return {
    ...
    Property_projectId_sadiId_elementIdGET(
      data: {
      ...
      config = {}
    ): Promise<IElementPropertyVoResponse> {
      return request({
     ...
     */
    Property_SearchPOST(
      data: IPropertySearchBo,
      config = {}
    ): Promise<IPropertySearchVoListResponse> {
      return request({
        url: `/property/search`,
    ...
    Property_Custom_projectId_sadiId_customElementIdGET(
      data: {
        projectId: number | string;
        sadiId: number | string;
        customElementId: number | string;
      },
      config = {}
    ): Promise<IElementPropertyVoResponse> {
      return request({
     ...
     */
    Property_Sadi_SamePOST(
      data: IQuerySameSadiPropertyBo,
      config = {}
    ): Promise<ISameSadiPropertyVoListResponse> {
      return request({
