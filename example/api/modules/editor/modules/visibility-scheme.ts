...
export function useVisibilitySchemeApi() {
  return {
    ...
    VisibilityScheme_projectId_sadiIdGET(
      data: { projectId: number | string; sadiId: number | string },
      config = {}
    ): Promise<IVsisibilityRecordVoListResponse> {
      return request({
     ...
     */
    VisibilitySchemePOST(
      data: IVisibilityRecordBo,
      config = {}
     ...
     */
    VisibilitySchemePUT(
      data: IUpdateVisibilityRecordBo,
      config = {}
    ...
    VisibilityScheme_projectId_sadiId_recordIdDELETE(
      data: {
    ...
    VisibilityScheme_Copy_projectId_sadiId_schemeIdPOST(
      data: {
        projectId: number | string;
        sadiId: number | string;
